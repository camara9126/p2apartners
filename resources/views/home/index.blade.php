	          ...
	          <div class="row no-gutters slider-text align-items-center justify-content-center">
		          <div class="col-md-8 ftco-animate">
		          	<div class="text w-100 text-center">
			            ...
			            <h3 class="mb-4 text-white">Une tenue rigoureuse de vos comptes en normes SYSCOHADA et IFRS pour une visibilité totale sur votre activité</h3>
			            <p><a href="contact" class="btn btn-white">Connectez-vous avec nous</a></p>
		            </div>
		          </div>
		        </div>
	        </div>
	          ...
	          <div class="row no-gutters slider-text align-items-center justify-content-center">
		          <div class="col-md-8 ftco-animate">
		          	<div class="text w-100 text-center">
			            ...
			            <h3 class="mb-4 text-white">Certification et fiabilisation de vos états financiers par des experts-comptables inscrits à l'Ordre</h3>
			            <p><a href="contact" class="btn btn-white">Connectez-vous avec nous</a></p>
		            </div>
		          </div>
		        </div>
	          ...
	          <div class="row no-gutters slider-text align-items-center justify-content-center">
		          <div class="col-md-8 ftco-animate">
		          	<div class="text w-100 text-center">
			            ...
			            <h3 class="mb-4 text-white">Optimisation fiscale, ingénierie financière et accompagnement à la levée de fonds pour propulser votre croissance</h3>
			            <p><a href="contact" class="btn btn-white">Connectez-vous avec nous</a></p>
		            </div>
		          </div>
		        </div>
    		...
    		<div class="row d-flex no-gutters">
    			...
    			<div class="col-md-6 pl-md-5 py-md-5">
    				<div class="heading-section pl-md-4 pt-md-5">
    					<span class="subheading">Bienvenu Chez P2APARTNERS</span>
	            <h2 class="mb-4">Pourquoi nous choisir ?</h2>
    				...
    				<div class="services-2 w-100 d-flex">
    					...
    					<div class="text pl-4">
    						...
    						<p>Nous ne nous contentons pas de saisir vos factures ; nous analysons vos données pour éclairer vos décisions</p>
    					</div>
    				</div>
    				<div class="services-2 w-100 d-flex">
    					<div class="icon d-flex align-items-center justify-content-center"><span class="flaticon-accountant"></span></div>
    					<div class="text pl-4">
    						<h4>Agilité Sectorielle</h4>
    						<p>Une expertise adaptée aux PME, Start-ups, et organisations à but non lucratif</p>
    					</div>
    				</div>
    				<div class="services-2 w-100 d-flex">
    					...
    					<div class="text pl-4">
    						...
    						<p>Une veille permanente sur la fiscalité et le droit social pour vous éviter tout risque réglementaire</p>
    					</div>
    				</div>
    				<div class="services-2 w-100 d-flex">
    					<div class="icon d-flex align-items-center justify-content-center"><span class="flaticon-accounting"></span></div>
    					<div class="text pl-4">
    						<h4>Innovation Digitale</h4>
    						<p>Un cabinet moderne utilisant les meilleurs outils pour simplifier votre gestion quotidienne</p>
    					</div>
    				</div>
	        </div>
        </div>
    ...
    <section class="ftco-section ftco-no-pt bg-light ftco-faqs">
    	<div class="container">
    		<div class="row">
	            ...
	            <h2 class="mb-3">Foire aux questions</h2>
    				...
    				<div id="accordion" class="myaccordion w-100" aria-multiselectable="true">
						  <div class="card">
						    <div class="card-header p-0" id="headingOne">
						      <h2 class="mb-0">
						        <button href="#collapseOne" class="d-flex py-3 px-4 align-items-center justify-content-between btn btn-link" data-parent="#accordion" data-toggle="collapse" aria-expanded="true" aria-controls="collapseOne">
						        	<p class="mb-0">Proposez-vous du conseil en gestion d'entreprise ? </p>
						    ...
						    <div class="collapse show" id="collapseOne" role="tabpanel" aria-labelledby="headingOne">
						      <div class="card-body py-3 px-0">
						      	<ol>
						      		<li>Oui, nous analysons vos performances pour optimiser vos coûts, </li>
						      		<li>améliorer votre rentabilité et structurer votre croissance</li>
						      	</ol>
						      </div>
						    </div>
						  </div>
						  ...
						  <div class="card">
						    <div class="card-header p-0" id="headingTwo" role="tab">
						      <h2 class="mb-0">
						        <button href="#collapseTwo" class="d-flex py-3 px-4 align-items-center justify-content-between btn btn-link" data-parent="#accordion" data-toggle="collapse" aria-expanded="false" aria-controls="collapseTwo">
						        	<p class="mb-0">Comment accompagnez-vous les entreprises en fiscalité ?</p>
						          <i class="fa" aria-hidden="true"></i>
						        </button>
						      </h2>
						    </div>
						    <div class="collapse" id="collapseTwo" role="tabpanel" aria-labelledby="headingTwo">
						      <div class="card-body py-3 px-0">
						      	<ol>
						      		<li>Nous gérons vos déclarations fiscales (TVA, IS)</li>
						      		<li>Optimisons votre stratégie pour garantir votre conformité tout en réduisant vos charges.</li>
						      	</ol>
						      </div>
						    </div>
						  </div>
						  ...
						  <div class="card">
						    <div class="card-header p-0" id="headingThree" role="tab">
						      <h2 class="mb-0">
						        <button href="#collapseThree" class="d-flex py-3 px-4 align-items-center justify-content-between btn btn-link" data-parent="#accordion" data-toggle="collapse" aria-expanded="false" aria-controls="collapseThree">
						        	<p class="mb-0">Proposez-vous une assistance en cas de contrôle fiscal ?</p>
						          <i class="fa" aria-hidden="true"></i>
						        </button>
						      </h2>
						    </div>
						    <div class="collapse" id="collapseThree" role="tabpanel" aria-labelledby="headingTwo">
						      <div class="card-body py-3 px-0">
						      	<ol>
						      		<li>Absolument. Nous vous assistons et vous représentons auprès de l'administration pour sécuriser vos intérêts et vos droits.</li>
						      	</ol>
						      </div>
						    </div>
						  </div>
						  ...
						  <div class="card">
						    <div class="card-header p-0" id="headingFour" role="tab">
						      <h2 class="mb-0">
						        <button href="#collapseFour" class="d-flex py-3 px-4 align-items-center justify-content-between btn btn-link" data-parent="#accordion" data-toggle="collapse" aria-expanded="false" aria-controls="collapseFour">
						        	<p class="mb-0">En quoi consiste votre assistance juridique ?</p>
						          <i class="fa" aria-hidden="true"></i>
						        </button>
						      </h2>
						    </div>
						    <div class="collapse" id="collapseFour" role="tabpanel" aria-labelledby="headingTwo">
						      <div class="card-body py-3 px-0">
						      	<p>Nous vous aidons dans la rédaction de contrats, la création de sociétés et la sécurisation juridique de toutes vos transactions commerciales.</p>
						      </div>
						    </div>
						  </div>
						</div>
      ...
      <div class="container">
        <div class="row justify-content-center pb-5 mb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
          	<span class="subheading">Actualitèe &amp; Blog</span>
