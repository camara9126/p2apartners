	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav m-auto">
	        	...
	        	<li class="nav-item active"><a href="about" class="nav-link">A propos</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs mb-2"><span class="mr-2"><a href="/">Accueil <i class="ion-ios-arrow-forward"></i></a></span> <span>A propos <i class="ion-ios-arrow-forward"></i></span></p>
    		...
    		<div class="row d-flex no-gutters">
    			...
    			<div class="col-md-6 pl-md-5 py-md-5">
    				<div class="heading-section pl-md-4 pt-md-5">
    					<span class="subheading">Bienvenue su P2A Partners</span>
						<h2 class="mb-4">Nous sommes un cabinet d’expertise comptable, d’audit et de conseils</h2>
						<p>Fort de son expertise pluridisciplinaire, le cabinet propose un accompagnement sur-mesure dans les domaines de la comptabilité, de l’audit, de la fiscalité, de la gestion sociale, du conseil stratégique et de la gestion financière.</p>
						<p>Notre mission ? Fournir bien plus que des services financiers. Chez P2A Partners, nous nous positionnons comme de véritables partenaires de croissance, en apportant à nos clients des solutions claires, adaptées à leur activité et à leurs enjeux.</p>
					</div>
				</div>
			</div>
    	</div>
