...
<head>
    ...
    <title>Transport & logistique - P2A Partners</title>
...
<body class="bg-white text-gray-900 font-sans">
    ...
    <!-- HERO SECTION TRANSPORT & LOGISTIQUE -->
    <section class="relative text-white py-24 px-6 lg:px-16 overflow-hidden bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=1920&q=80');">
        ...
        <div class="max-w-5xl mx-auto relative z-10">
            ...
            <h1 class="text-4xl lg:text-6xl font-serif mb-6">Transport & logistique</h1>
            <p class="text-lg lg:text-xl text-gray-300 font-light max-w-2xl">
                Maîtriser les coûts, les actifs, les flux physiques et la rentabilité des opérations.
            </p>
        </div>
    </section>
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
                ...
                <div class="space-y-6">
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <h3 class="text-xl font-serif mt-1 text-gray-900">Suivi des coûts par trajet ou activité</h3>
                    </div>
                    <div class="border-b border-gray-200 pb-6">
                        <span class="text-xs text-gray-400 font-mono">02</span>
                        <h3 class="text-xl font-serif mt-1 text-gray-900">Gestion des flottes et immobilisations</h3>
                    </div>
                    <div class="border-b border-gray-200 pb-6">
                        <span class="text-xs text-gray-400 font-mono">03</span>
                        <h3 class="text-xl font-serif mt-1 text-gray-900">Contrôle des flux, stocks et sous-traitants</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-[#f9f8f6] p-10 border-l-4 border-[#0b131d]">
                ...
                <h2 class="text-2xl lg:text-3xl font-serif text-gray-900 leading-snug">
                    Nous relions les données opérationnelles et financières pour améliorer le suivi des coûts, de la trésorerie et de la performance logistique.
                </h2>
            </div>
