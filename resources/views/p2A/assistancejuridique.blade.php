...
<head>
    ...
    <title>Assistance Juridique - P2A Partners</title>
...
<body class="bg-white text-gray-900 font-sans">
    ...
    <!-- HERO SECTION ASSISTANCE JURIDIQUE -->
    <section class="relative text-white py-24 px-6 lg:px-16 overflow-hidden bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=1920&q=80');">
        <div class="absolute inset-0 bg-gradient-to-r from-[#0b131d] via-[#0b131d]/90 to-[#0b131d]/50"></div>

        <div class="max-w-5xl mx-auto relative z-10">
            <p class="text-xs uppercase tracking-widest text-gray-400 mb-4"><a href="service" class="hover:underline">Ce que nous faisons</a></p>
            <h1 class="text-4xl lg:text-6xl font-serif mb-6">Assistance Juridique</h1>
    ...
    <!-- SECTION VOTRE ENJEU -->
    <section class="py-20 px-6 lg:px-16 bg-white border-b border-gray-100">
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                <p class="text-xs uppercase tracking-widest text-gray-500 mb-4 font-semibold">Votre enjeu</p>
                <h2 class="text-3xl lg:text-4xl font-serif text-gray-900 leading-snug">
                    Sécuriser la vie juridique de l'organisation.
                </h2>
            </div>
            <div>
                <p class="text-gray-600 text-base leading-relaxed">
                    Les décisions sociales, les changements statutaires et les obligations juridiques courantes exigent une documentation rigoureuse et un calendrier maîtrisé.
                </p>
            </div>
        </div>
    </section>

    <!-- SECTION NOTRE APPROCHE & LIVRABLES -->
    <section class="py-20 px-6 lg:px-16 bg-[#f9f8f6]">
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            
            <!-- Notre approche -->
            <div class="bg-white p-10 border-l-4 border-[#0b131d] shadow-sm">
                <p class="text-xs uppercase tracking-widest text-gray-500 mb-4 font-semibold">Notre approche</p>
                <h3 class="text-2xl lg:text-3xl font-serif text-gray-900 leading-snug">
                    Nous préparons et suivons les formalités relevant de notre périmètre d'intervention, dans le respect des habilitations applicables et, lorsque nécessaire, en coordination avec les conseils juridiques du client.
                </h3>
            </div>

            <!-- Livrables -->
            <div>
                <p class="text-xs uppercase tracking-widest text-gray-500 mb-6 font-semibold">Livrables</p>
                <ul class="space-y-4">
                    <li class="flex items-start space-x-3 pb-3 border-b border-gray-200">
                        <svg class="w-5 h-5 text-blue-900 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        <span class="text-gray-800 font-medium text-sm lg:text-base">Assistance aux formalités de création et de modification</span>
                    </li>
                    <li class="flex items-start space-x-3 pb-3 border-b border-gray-200">
                        <svg class="w-5 h-5 text-blue-900 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        <span class="text-gray-800 font-medium text-sm lg:text-base">Préparation documentaire des assemblées ordinaires</span>
                    </li>
                    <li class="flex items-start space-x-3 pb-3 border-b border-gray-200">
                        <svg class="w-5 h-5 text-blue-900 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        <span class="text-gray-800 font-medium text-sm lg:text-base">Mise à jour des registres sociaux</span>
                    </li>
                    <li class="flex items-start space-x-3 pb-3 border-b border-gray-200">
                        <svg class="w-5 h-5 text-blue-900 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        <span class="text-gray-800 font-medium text-sm lg:text-base">Suivi des échéances juridiques courantes</span>
                    </li>
                    <li class="flex items-start space-x-3 pb-3 border-b border-gray-200">
                        <svg class="w-5 h-5 text-blue-900 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        <span class="text-gray-800 font-medium text-sm lg:text-base">Coordination documentaire avec les conseils spécialisés</span>
                    </li>
                </ul>
            </div>
    ...
    <!-- SECTION SECTEURS CONCERNÉS -->
    <section class="py-16 px-6 lg:px-16 bg-white border-t border-gray-100">
        <div class="max-w-6xl mx-auto">
            <p class="text-xs uppercase tracking-widest text-gray-500 mb-6 font-semibold">Secteurs concernés</p>
            <div class="flex flex-wrap gap-4">
                <span class="border border-gray-300 text-gray-800 px-6 py-3 text-sm font-medium rounded hover:border-gray-900 transition-colors">Entreprises et groupes</span>
                <span class="border border-gray-300 text-gray-800 px-6 py-3 text-sm font-medium rounded hover:border-gray-900 transition-colors">ONG et secteur public</span>
                <span class="border border-gray-300 text-gray-800 px-6 py-3 text-sm font-medium rounded hover:border-gray-900 transition-colors">Investisseurs et porteurs de projet</span>
            </div>
        </div>
    </section>
