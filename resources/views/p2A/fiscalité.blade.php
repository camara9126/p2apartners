...
<head>
    ...
    <title>Fiscalité & conformité - P2A Partners</title>
...
<body class="bg-white text-gray-900 font-sans">
    ...
    <!-- HERO SECTION FISCALITÉ & CONFORMITÉ -->
    <section class="relative text-white py-24 px-6 lg:px-16 overflow-hidden bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=1920&q=80');">
        ...
        <div class="max-w-5xl mx-auto relative z-10">
            ...
            <h1 class="text-4xl lg:text-6xl font-serif mb-6">Fiscalité & conformité</h1>
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <h2 class="text-3xl lg:text-4xl font-serif text-gray-900 leading-snug">
                    Sécuriser la conformité et anticiper le risque fiscal.
                </h2>
            </div>
            <div>
                <p class="text-gray-600 text-base leading-relaxed">
                    La multiplication des obligations et l'évolution des textes rendent la conformité difficile à maintenir sans organisation structurée.
                </p>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div class="bg-white p-10 border-l-4 border-[#0b131d] shadow-sm">
                ...
                <h3 class="text-2xl lg:text-3xl font-serif text-gray-900 leading-snug">
                    Nous rapprochons les déclarations de la comptabilité, documentons les positions et préparons les échanges avec l'administration.
                </h3>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li class="flex items-start space-x-3 pb-3 border-b border-gray-200">
                        ...
                        <span class="text-gray-800 font-medium text-sm lg:text-base">Déclarations fiscales</span>
                    </li>
                    <li class="flex items-start space-x-3 pb-3 border-b border-gray-200">
                        <svg class="w-5 h-5 text-blue-900 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        <span class="text-gray-800 font-medium text-sm lg:text-base">Revue de conformité</span>
                    </li>
                    <li class="flex items-start space-x-3 pb-3 border-b border-gray-200">
                        <svg class="w-5 h-5 text-blue-900 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        <span class="text-gray-800 font-medium text-sm lg:text-base">Assistance au contrôle fiscal</span>
                    </li>
                    <li class="flex items-start space-x-3 pb-3 border-b border-gray-200">
                        <svg class="w-5 h-5 text-blue-900 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        <span class="text-gray-800 font-medium text-sm lg:text-base">Fiscalité des investissements</span>
                    </li>
                    <li class="flex items-start space-x-3 pb-3 border-b border-gray-200">
                        <svg class="w-5 h-5 text-blue-900 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        <span class="text-gray-800 font-medium text-sm lg:text-base">Veille et calendrier fiscal</span>
                    </li>
                </ul>
            </div>
    ...
    <section class="py-16 px-6 lg:px-16 bg-white border-t border-gray-100">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="flex flex-wrap gap-4">
                <span class="border border-gray-300 text-gray-800 px-6 py-3 text-sm font-medium rounded hover:border-gray-900 transition-colors">Tous secteurs</span>
                <span class="border border-gray-300 text-gray-800 px-6 py-3 text-sm font-medium rounded hover:border-gray-900 transition-colors">Investisseurs</span>
                <span class="border border-gray-300 text-gray-800 px-6 py-3 text-sm font-medium rounded hover:border-gray-900 transition-colors">Entreprises en implantation</span>
            </div>
        </div>
    </section>
