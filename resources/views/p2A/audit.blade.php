...
<head>
    ...
    <title>Audit & commissariat aux comptes - P2A Partners</title>
...
<body class="bg-white text-gray-900 font-sans">
    ...
    <!-- HERO SECTION AUDIT & COMMISSARIAT AUX COMPTES -->
    <section class="relative text-white py-24 px-6 lg:px-16 overflow-hidden bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&w=1920&q=80');">
        ...
        <div class="max-w-5xl mx-auto relative z-10">
            ...
            <h1 class="text-4xl lg:text-6xl font-serif mb-6">Audit & commissariat aux comptes</h1>
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <h2 class="text-3xl lg:text-4xl font-serif text-gray-900 leading-snug">
                    Renforcer la confiance dans l'information financière.
                </h2>
            </div>
            <div>
                <p class="text-gray-600 text-base leading-relaxed">
                    Les actionnaires, financeurs et organes de gouvernance ont besoin d'une information financière crédible et d'une vision claire du contrôle interne.
                </p>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div class="bg-white p-10 border-l-4 border-[#0b131d] shadow-sm">
                ...
                <h3 class="text-2xl lg:text-3xl font-serif text-gray-900 leading-snug">
                    Nos travaux sont planifiés selon les risques, documentés et conduits dans le respect des habilitations professionnelles applicables.
                </h3>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li class="flex items-start space-x-3 pb-3 border-b border-gray-200">
                        ...
                        <span class="text-gray-800 font-medium text-sm lg:text-base">Audit légal et contractuel</span>
                    </li>
                    <li class="flex items-start space-x-3 pb-3 border-b border-gray-200">
                        <svg class="w-5 h-5 text-blue-900 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        <span class="text-gray-800 font-medium text-sm lg:text-base">Commissariat aux comptes</span>
                    </li>
                    <li class="flex items-start space-x-3 pb-3 border-b border-gray-200">
                        <svg class="w-5 h-5 text-blue-900 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        <span class="text-gray-800 font-medium text-sm lg:text-base">Revue limitée</span>
                    </li>
                    <li class="flex items-start space-x-3 pb-3 border-b border-gray-200">
                        <svg class="w-5 h-5 text-blue-900 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        <span class="text-gray-800 font-medium text-sm lg:text-base">Audit de projets et financements</span>
                    </li>
                    <li class="flex items-start space-x-3 pb-3 border-b border-gray-200">
                        <svg class="w-5 h-5 text-blue-900 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        <span class="text-gray-800 font-medium text-sm lg:text-base">Recommandations de contrôle interne</span>
                    </li>
                </ul>
            </div>
    ...
    <section class="py-16 px-6 lg:px-16 bg-white border-t border-gray-100">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="flex flex-wrap gap-4">
                <span class="border border-gray-300 text-gray-800 px-6 py-3 text-sm font-medium rounded hover:border-gray-900 transition-colors">ONG et bailleurs</span>
                <span class="border border-gray-300 text-gray-800 px-6 py-3 text-sm font-medium rounded hover:border-gray-900 transition-colors">Groupes internationaux</span>
                <span class="border border-gray-300 text-gray-800 px-6 py-3 text-sm font-medium rounded hover:border-gray-900 transition-colors">Éducation</span>
            </div>
        </div>
    </section>
