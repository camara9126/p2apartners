...
<head>
    ...
    <title>Automobile - P2A Partners</title>
...
<body class="bg-white text-gray-900 font-sans">
    ...
    <!-- HERO SECTION AUTOMOBILE AVEC IMAGE DE FOND ET VOILE FAIBLE -->
    <section class="relative text-white py-24 px-6 lg:px-16 overflow-hidden bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&w=1920&q=80');">
        <!-- Voile sombre à intensité faible sur la gauche (pour laisser deviner l'image à droite) -->
        ...
        <div class="max-w-5xl mx-auto relative z-10">
            ...
            <h1 class="text-4xl lg:text-6xl font-serif mb-6">Automobile</h1>
            <p class="text-lg lg:text-xl text-gray-300 font-light max-w-2xl">
                Stocks, marges, pièces détachées et performance des réseaux de distribution.
            </p>
        </div>
    </section>
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
                ...
                <div class="space-y-6">
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <h3 class="text-xl font-serif mt-1 text-gray-900">Valorisation des véhicules et pièces</h3>
                    </div>
                    <div class="border-b border-gray-200 pb-6">
                        <span class="text-xs text-gray-400 font-mono">02</span>
                        <h3 class="text-xl font-serif mt-1 text-gray-900">Suivi des marges par activité</h3>
                    </div>
                    <div class="border-b border-gray-200 pb-6">
                        <span class="text-xs text-gray-400 font-mono">03</span>
                        <h3 class="text-xl font-serif mt-1 text-gray-900">Contrôle des ventes et services après-vente</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-[#f9f8f6] p-10 border-l-4 border-[#0b131d]">
                ...
                <h2 class="text-2xl lg:text-3xl font-serif text-gray-900 leading-snug">
                    Nous rapprochons les données commerciales, les stocks et la comptabilité pour donner une lecture fiable de la performance des activités automobiles.
                </h2>
            </div>
