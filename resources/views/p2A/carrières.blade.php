...
<head>
    ...
    <title>Carrières - P2A Partners</title>
...
<body class="bg-white text-gray-900 font-sans">
    ...
    <section class="relative text-white py-24 px-6 lg:px-16 overflow-hidden bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=1920&q=80');">
        ...
        <div class="max-w-5xl mx-auto relative z-10">
            <p class="text-xs uppercase tracking-widest text-gray-400 mb-4"><a href="apropos" class="hover:underline">Qui nous sommes</a></p>
            <h1 class="text-4xl lg:text-6xl font-serif mb-6">Construire une expertise qui compte</h1>
            <p class="text-lg lg:text-xl text-gray-300 font-light max-w-2xl">
                Rejoindre P2A Partners, c'est apprendre sur des missions exigeantes, au contact direct des clients et d'associés disponibles.
            </p>
        </div>
    </section>

    <!-- SECTION NOS VALEURS / PILIERS -->
    <section class="py-20 px-6 lg:px-16 bg-white border-b border-gray-100">
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div class="border-t border-gray-300 pt-6">
                <span class="text-xs font-bold text-gray-400 block mb-2">01</span>
                <h3 class="text-2xl font-serif text-gray-900 mb-3">Responsabilité</h3>
                <p class="text-gray-600 text-sm leading-relaxed">
                    Prendre en charge son travail avec un cadre clair et un retour régulier.
                </p>
            </div>

            <!-- Pilier 2 -->
            <div class="border-t border-gray-300 pt-6">
                <span class="text-xs font-bold text-gray-400 block mb-2">02</span>
                <h3 class="text-2xl font-serif text-gray-900 mb-3">Transmission</h3>
                <p class="text-gray-600 text-sm leading-relaxed">
                    Partager les méthodes, les retours d'expérience et les standards professionnels.
                </p>
            </div>

            <!-- Pilier 3 -->
            <div class="border-t border-gray-300 pt-6">
                <span class="text-xs font-bold text-gray-400 block mb-2">03</span>
                <h3 class="text-2xl font-serif text-gray-900 mb-3">Progression</h3>
                <p class="text-gray-600 text-sm leading-relaxed">
                    Développer une pratique solide de l'audit, de la comptabilité et du conseil.
                </p>
            </div>
    ...
    <!-- SECTION OFFRES DISPONIBLES & CANDIDATURE SPONTANÉE -->
    <section class="py-20 px-6 lg:px-16 bg-[#f9f8f6]">
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <!-- Image / Illustration -->
            <div>
                <img src="https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&w=800&q=80" alt="Offres d'emploi" class="w-full h-auto shadow-md object-cover">
            </div>

            <!-- Texte & Action -->
            <div>
                <p class="text-xs uppercase tracking-widest text-gray-500 mb-3 font-semibold">Offres disponibles</p>
                <h2 class="text-2xl lg:text-3xl font-serif text-gray-900 mb-4 leading-snug">
                    Aucune offre n'est publiée actuellement. Les candidatures spontanées restent ouvertes.
                </h2>
                <div class="mt-8 border-t border-gray-200 pt-8">
                    <h3 class="text-lg font-serif text-gray-900 mb-2">Candidature spontanée</h3>
                    <p class="text-gray-600 text-sm mb-6">Envoyez votre CV et quelques lignes sur votre projet professionnel.</p>
                    <a href="contact" class="inline-block bg-[#0b131d] text-white px-6 py-3 text-xs uppercase tracking-widest font-medium hover:bg-blue-900 transition-colors">
