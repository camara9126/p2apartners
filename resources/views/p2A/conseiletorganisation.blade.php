...
<head>
    ...
    <title>Conseil & organisation - P2A Partners</title>
...
<body class="bg-white text-gray-900 font-sans">
    ...
    <!-- HERO SECTION CONSEIL & ORGANISATION -->
    <section class="relative text-white py-24 px-6 lg:px-16 overflow-hidden bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&w=1920&q=80');">
        ...
        <div class="max-w-5xl mx-auto relative z-10">
            ...
            <h1 class="text-4xl lg:text-6xl font-serif mb-6">Conseil & organisation</h1>
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <h2 class="text-3xl lg:text-4xl font-serif text-gray-900 leading-snug">
                    Structurer les processus pour soutenir la croissance.
                </h2>
            </div>
            <div>
                <p class="text-gray-600 text-base leading-relaxed">
                    Une croissance rapide révèle souvent des procédures informelles, des responsabilités mal définies et des contrôles insuffisants.
                </p>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div class="bg-white p-10 border-l-4 border-[#0b131d] shadow-sm">
                ...
                <h3 class="text-2xl lg:text-3xl font-serif text-gray-900 leading-snug">
                    Nous partons des flux réels, associons les équipes et construisons des procédures proportionnées à l'organisation.
                </h3>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li class="flex items-start space-x-3 pb-3 border-b border-gray-200">
                        ...
                        <span class="text-gray-800 font-medium text-sm lg:text-base">Manuels de procédures</span>
                    </li>
                    <li class="flex items-start space-x-3 pb-3 border-b border-gray-200">
                        <svg class="w-5 h-5 text-blue-900 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        <span class="text-gray-800 font-medium text-sm lg:text-base">Cartographie des risques</span>
                    </li>
                    <li class="flex items-start space-x-3 pb-3 border-b border-gray-200">
                        <svg class="w-5 h-5 text-blue-900 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        <span class="text-gray-800 font-medium text-sm lg:text-base">Diagnostic de contrôle interne</span>
                    </li>
                    <li class="flex items-start space-x-3 pb-3 border-b border-gray-200">
                        <svg class="w-5 h-5 text-blue-900 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        <span class="text-gray-800 font-medium text-sm lg:text-base">Délégations et matrices de responsabilités</span>
                    </li>
                    <li class="flex items-start space-x-3 pb-3 border-b border-gray-200">
                        <svg class="w-5 h-5 text-blue-900 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        <span class="text-gray-800 font-medium text-sm lg:text-base">Plans d'action</span>
                    </li>
                </ul>
            </div>
    ...
    <section class="py-16 px-6 lg:px-16 bg-white border-t border-gray-100">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="flex flex-wrap gap-4">
                ...
                <span class="border border-gray-300 text-gray-800 px-6 py-3 text-sm font-medium rounded hover:border-gray-900 transition-colors">Industrie</span>
                <span class="border border-gray-300 text-gray-800 px-6 py-3 text-sm font-medium rounded hover:border-gray-900 transition-colors">PME en croissance</span>
            </div>
        </div>
    </section>
