...
<head>
    ...
    <title>Expertise comptable - P2A Partners</title>
...
<body class="bg-white text-gray-900 font-sans">
    ...
    <!-- HERO SECTION EXPERTISE COMPTABLE -->
    <section class="relative text-white py-24 px-6 lg:px-16 overflow-hidden bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=1920&q=80');">
        ...
        <div class="max-w-5xl mx-auto relative z-10">
            <p class="text-xs uppercase tracking-widest text-gray-400 mb-4">Ce que nous faisons</p>
            <h1 class="text-4xl lg:text-6xl font-serif mb-6">Expertise comptable</h1>
    ...
    <!-- SECTION VOTRE ENJEU -->
    <section class="py-16 px-6 lg:px-16 bg-white border-b border-gray-100">
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                <p class="text-xs uppercase tracking-widest text-gray-400 mb-2 font-semibold">Votre enjeu</p>
                <h2 class="text-3xl lg:text-4xl font-serif text-gray-900 leading-snug">
                    Disposer de comptes fiables, au bon moment.
                </h2>
            </div>
            <div>
                <p class="text-gray-600 text-base leading-relaxed">
                    Des clôtures tardives ou des données peu fiables limitent la capacité du dirigeant à décider et exposent l'entreprise à des risques de conformité.
                </p>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
                ...
                <h3 class="text-2xl lg:text-3xl font-serif text-gray-900 leading-snug">
                    Nous adaptons l'organisation comptable au volume d'activité, aux compétences internes et aux exigences de reporting.
                </h3>
            </div>
            ...
            <div class="bg-white p-8 border border-gray-200 shadow-sm">
                ...
                <ul class="space-y-4 text-gray-800">
                    <li class="flex items-center space-x-3 border-b border-gray-100 pb-3">
                        <span class="text-blue-600 font-bold">&#10003;</span>
                        <span class="text-sm font-medium">Tenue et supervision comptable</span>
                    </li>
                    <li class="flex items-center space-x-3 border-b border-gray-100 pb-3">
                        <span class="text-blue-600 font-bold">&#10003;</span>
                        <span class="text-sm font-medium">Révision et clôtures périodiques</span>
                    </li>
                    <li class="flex items-center space-x-3 border-b border-gray-100 pb-3">
                        <span class="text-blue-600 font-bold">&#10003;</span>
                        <span class="text-sm font-medium">États financiers SYSCOHADA</span>
                    </li>
                    <li class="flex items-center space-x-3 border-b border-gray-100 pb-3">
                        <span class="text-blue-600 font-bold">&#10003;</span>
                        <span class="text-sm font-medium">États financiers IFRS</span>
                    </li>
                    <li class="flex items-center space-x-3 border-b border-gray-100 pb-3">
                        <span class="text-blue-600 font-bold">&#10003;</span>
                        <span class="text-sm font-medium">Reporting de gestion</span>
                    </li>
                    <li class="flex items-center space-x-3 pb-1">
                        <span class="text-blue-600 font-bold">&#10003;</span>
                        <span class="text-sm font-medium">Préparation des dossiers d'audit</span>
                    </li>
                </ul>
            </div>
    ...
    <section class="py-16 px-6 lg:px-16 bg-white">
        <div class="max-w-6xl mx-auto">
            <p class="text-xs uppercase tracking-widest text-gray-400 mb-6 font-semibold">Secteurs concernés</p>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="border border-gray-200 p-5 text-center text-sm font-medium text-gray-800 bg-gray-50">
                    PME et services
                </div>
                <div class="border border-gray-200 p-5 text-center text-sm font-medium text-gray-800 bg-gray-50">
