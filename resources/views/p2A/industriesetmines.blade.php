...
<head>
    ...
    <title>Industries & mines - P2A Partners</title>
...
<body class="bg-white text-gray-900 font-sans">
    ...
    <!-- HERO SECTION AVEC VRAIE IMAGE DE FOND ET VOILE BLEU/SOMBRE -->
    <section class="relative text-white py-24 px-6 lg:px-16 overflow-hidden bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&w=1920&q=80');">
        <!-- Voile de superposition sombre pour garder la lisibilité du texte -->
        <div class="absolute inset-0 bg-[#0b131d]/85"></div>

        <div class="max-w-5xl mx-auto relative z-10">
            <p class="text-xs uppercase tracking-widest text-gray-400 mb-4">Qui nous accompagnons</p>
            <h1 class="text-4xl lg:text-6xl font-serif mb-6">Industries & mines</h1>
            <p class="text-lg lg:text-xl text-gray-300 font-light max-w-2xl">
                Coûts de production, stocks, investissements et contrôle des opérations.
            </p>
        </div>
    </section>
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
                ...
                <div class="space-y-6">
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <h3 class="text-xl font-serif mt-1 text-gray-900">Suivi des coûts et des rendements</h3>
                    </div>
                    <div class="border-b border-gray-200 pb-6">
                        <span class="text-xs text-gray-400 font-mono">02</span>
                        <h3 class="text-xl font-serif mt-1 text-gray-900">Valorisation des stocks et immobilisations</h3>
                    </div>
                    <div class="border-b border-gray-200 pb-6">
                        <span class="text-xs text-gray-400 font-mono">03</span>
                        <h3 class="text-xl font-serif mt-1 text-gray-900">Contrôle des flux sur les sites</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-[#f9f8f6] p-10 border-l-4 border-[#0b131d]">
                ...
                <h2 class="text-2xl lg:text-3xl font-serif text-gray-900 leading-snug">
                    Nous structurons l'information financière autour des cycles industriels et miniers afin de fiabiliser les clôtures, les marges et les décisions d'investissement.
                </h2>
            </div>
