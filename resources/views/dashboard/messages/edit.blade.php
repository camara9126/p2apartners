...
<body>
    <div class="dashboard-container mt-4">
        ...
        <div class="calendar-mini">
            <form action="{{ route('contactForm.update', $message) }}" method="post">
                @csrf
                @method('PUT')
                    
                    <div class="row mb-4">
                        <p class="mt-2"><i class="fas fa-user"></i>Nom :
                            {{ $message->nom }}
                        </p>
                        <p class="mt-2"><i class="fas fa-enveloops"></i>Email :
                            {{ $message->email }}
                        </p>
                        <p class="mt-2"><i class="fas fa-tags"></i>Sujet :
                            {{ $message->sujet }}
                        </p>
                    </div>
                    ...
                    <div class="row mt-4" style="text-align: center;">
                        <div class="col-md-6">
                            <button type="submit" class="btn btn-outline-warning">Marquer comme lu</button>
                        </div>
                        <div class="col-md-6">
